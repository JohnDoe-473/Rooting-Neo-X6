...
- In the unzipped folder : double click on  '1. Install Rooted Boot image.bat' to run the batch file.
o - - - - - o - - - - -     Step 2    - - - - - o - - - - - o - - - - - o - - - - - o
...
- If  you open Magisk now, you see  "Abnormal State ... bah..bah..bah" complaint
 ...
 Old legacy apps like Titanium Backup's 1st pick will choose SuperSU but newer ones will go for  Magisk.
...
- Important : A box will show up on the screen, Click okay to grant root permission. (Hurry, you only got 10 seconds before it goes away.)
  A lot of people missed this. If this time or the next time, some programs try to ask for Root permission and you missed it, 
 you won't get a second chance. Magisk took the "missed it and forget it" approach. You have to open Magisk app, 
